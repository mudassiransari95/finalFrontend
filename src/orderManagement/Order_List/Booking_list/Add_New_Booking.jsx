...
const Add_New_Booking = () => {
  ...
  <div className="w-96 mt-4 flex flex-col gap-5">
    <div className="flex">
      <select className="h-11 w-full text-center border border-gray-400 rounded-lg outline-none">
    ...
    <div className="flex flex-col">
      ...
      <input type="date" className="h-10 w-full text-center border border-gray-400 rounded-lg outline-none" />
    </div>

    <div className="flex">
      <input type="number" placeholder="Process Loss" className="h-10 w-full text-center border border-gray-400 rounded-lg outline-none" />
    </div>

    <div className="flex">
      <input type="text" placeholder="Rib" className="h-10 w-full text-center border border-gray-400 rounded-lg outline-none" />
    </div>
  </div>
  ...
  <div className="w-96 mt-4 flex flex-col gap-5">
    <div className="flex">
      <input type="text" placeholder="Prepared By" className="h-10 w-full text-center border border-gray-400 rounded-lg outline-none" />
    </div>
    <div className="flex">
      <input type="text" placeholder="Composition" className="h-10 w-full text-center border border-gray-400 rounded-lg outline-none" />
    </div>
    <div className="flex">
      <input type="text" placeholder="Others Fabric" className="h-10 w-full text-center border border-gray-400 rounded-lg outline-none" />
    </div>
    <div className="flex">
      <input type="text" placeholder="Collar" className="h-10 w-full text-center border border-gray-400 rounded-lg outline-none" />
    </div>
  </div>

  {/* Third Column */}
  <div className="w-96 mt-1 flex flex-col gap-5 absolute left-[63rem] bg-gray-200 p-2">
    <div className="flex">
      <p htmlFor="upload" className="flex flex-col items-center justify-center cursor-pointer border-2  rounded-lg p-2">
