...
<div className='w-60 bg-green-300 h-20  doller-buyer pl-9 pt-3' style={{borderRadius:"1rem"}} >
 ...
 Due Amount
      ...
      {/* form */}
      <div className=' w-100 bg-red-600 mt-14 h-20 flex items-center justify-center' >
...
<FaFileCsv  className='text-pink-400' style={{fontSize:"20px"}}/>
       ...
       {/* table */}
       <table ref={componentRef} className="table tableone mt-10 ms-3 p-2" style={{fontFamily:"monospace",fontSize:"15px"}}>
  <thead>
